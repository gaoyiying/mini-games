...
public class Jigsaw_puzzle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_pt_go=findViewById(R.id.pt_go);
        btn_pt_go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jigsaw_puzzle.this, MainActivity.class);
